...
/** 获取代码生成配置 */
export function getGenConfig(tableName) {
    return request({
...
/** 保存代码生成配置 */
export function saveGenConfig(tableName, data) {
    return request({
        url: `${GENERATOR_BASE_URL}/${tableName}/config`,
        method: "post",
        data,
...
/** 获取代码生成预览数据 */
export function getPreviewData(tableName, pageType, type) {
    return request({
...
/** 重置代码生成配置 */
export function resetGenConfig(tableName) {
    return request({
        url: `${GENERATOR_BASE_URL}/${tableName}/config`,
        method: "delete",
    });
...
/** 下载代码生成 ZIP 文件 */
export function downloadZip(tableName, pageType, type) {
    return request({
