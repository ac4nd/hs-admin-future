...
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
    ...
    ...{ class: ({ 'bg-primary/10 text-primary font-medium': String(__VLS_ctx.node.value) === __VLS_ctx.selectedValue }) },
});
...
if (__VLS_ctx.expanded && __VLS_ctx.node.children?.length) {
    ...
    for (const [child] of __VLS_vFor((__VLS_ctx.node.children))) {
        let __VLS_5;
        /** @ts-ignore @type { | typeof __VLS_components.MenuTreeNode} */
        MenuTreeNode;
        // @ts-ignore
        ...
        var __VLS_9;
        // @ts-ignore
        [handleClick, node, node, node, node, node, selectedValue, selectedValue, expanded, expanded, keyword, emit,];
    }
}
// @ts-ignore
[];
...
export default {};
//# sourceMappingURL=MenuTreeNode.vue.js.map