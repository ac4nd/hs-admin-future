...
<template>
  ...
  >
    ...
    <div v-if="items.length > 1" class="flex items-center justify-center gap-2 pt-3">
      <button class="text-sm text-muted-foreground hover:text-foreground transition-colors px-2" @click="prev">&lt;</button>
      ...
      <button class="text-sm text-muted-foreground hover:text-foreground transition-colors px-2" @click="next">&gt;</button>
    </div>
  </GlassSurface>
